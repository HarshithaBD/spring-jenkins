...
public class CoderController {
	...
	public String deleteCoders(List<Coder> e)throws Throwable
	{
		coderservice.deleteCoders(e);
	...
	public String deleteCoderById(@PathVariable int eid)throws Throwable
	{
